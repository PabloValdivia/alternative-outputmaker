...
/** Generated Interface for OM_Input
 *  @author iDempiere (generated) 
 *  @version Release 2.1
 */
@SuppressWarnings("all")
public interface I_OM_Input 
{

    /** TableName=OM_Input */
    public static final String Table_Name = "OM_Input";
    ...
    public static final String COLUMNNAME_CommonValue = "CommonValue";
    ...
    /** Column name OM_Input_ID */
    public static final String COLUMNNAME_OM_Input_ID = "OM_Input_ID";
    ...
    /** Column name OM_Input_UU */
    public static final String COLUMNNAME_OM_Input_UU = "OM_Input_UU";
    ...
    /** Column name SQLjoin */
    public static final String COLUMNNAME_SQLjoin = "SQLjoin";
